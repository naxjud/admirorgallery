...
class agGallery extends agHelper {
   ...
   // const PLUGIN_BASE_PATH = '/plugins/content/AdmirorGallery/';
     ...
     */
    function initPopup(){
        require ('plugins/content/AdmirorGallery/AdmirorGallery/popups/'.$this->params['popupEngine'].'/index.php');
    ...
    function  __construct($globalParams) {
        $this->staticParams['th_height']= $this->ag_getParams('th_height',$globalParams, 120);
        $this->staticParams['template']= $this->ag_getParams('template',$globalParams, 'classic');
        $this->staticParams['newImageTag']= $this->ag_getParams('newImageTag',$globalParams, true);
        $this->staticParams['newImageTag_days']= $this->ag_getParams('newImageTag_days',$globalParams, '7');
        $this->staticParams['sortImages']= $this->ag_getParams('sortImages',$globalParams, false);
        $this->staticParams['frame_width']= $this->ag_getParams('frame_width',$globalParams, false);
        $this->staticParams['frame_height']= $this->ag_getParams('frame_height',$globalParams, false);
        $this->staticParams['showSignature']= $this->ag_getParams('showSignature',$globalParams, '1');
        $this->staticParams['popupEngine']= $this->ag_getParams('popupEngine',$globalParams, 'slimbox');
        $this->staticParams['usePopuEngine']= $this->ag_getParams('usePopuEngine',$globalParams, true);
        $this->staticParams['ignoreError']= $this->ag_getParams('ignoreError',$globalParams, true);
        $this->staticParams['ignoreAllError']= $this->ag_getParams('ignoreAllError',$globalParams, false);
        $this->staticParams['loadjQuery']= $this->ag_getParams('loadjQuery',$globalParams, true);
        $this->staticParams['jQueryNoConflict']= $this->ag_getParams('jQueryNoConflict',$globalParams, true);
        $this->staticParams['rootFolder']= $this->ag_getParams('rootFolder',$globalParams,'/images/sampledata/');
