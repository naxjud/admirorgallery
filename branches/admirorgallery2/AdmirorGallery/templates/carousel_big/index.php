...
// Load JavaScript from current template folder
...
// Loops over the array of images inside target gallery folder, adding images inside of list items
...
// Adding control buttons for navigate throught gallery images
...
// Insert JavaScript code after gallery is formed. This init carousel scripts and do additional style adjustments
$AG->insertJSCode('
jQuery(function(){
