...
quickiconButton( $link, 'icon-48-templates.png', JText::_('AG_TEMPLATES'), $AG_templateID );

$link = 'index.php?option=com_admirorgallery&view=resourcemanager&AG_resourceType=popups';
quickiconButton( $link, 'icon-48-popups.png', JText::_('AG_POPUPS'), $AG_templateID );

$link = 'index.php?option=com_admirorgallery&view=imagemanager';
quickiconButton( $link, 'icon-48-imagemanager.png', JText::_('AG_IMAGE_MANAGER'), $AG_templateID );
...
echo $myparams->render();
//print_r($myparams->render( 'params' ));
