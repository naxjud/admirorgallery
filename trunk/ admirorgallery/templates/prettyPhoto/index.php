...
if (!empty($images)){
	foreach ($images as $imagesKey => $imagesValue){
		$html .= '<span class="ag_thumb"><a href="'.$joomla_site_path.$rootFolder.$imagesFolder_name.'/'.$imagesValue.'" rel="prettyPhoto'.$galleryCount.'[AdmirorGallery'.$galleryCount.']" title="';
