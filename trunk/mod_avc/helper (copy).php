...
class AVC {
    ...
    private $avc_fields_config; // List of Databases Identifier
    private $dbConfig;
    private $dbObject;
    private $tableAlias;
    ...
    function __construct($moduleID, $tableID, $tmpTable, $tmpRow) {
        $this->avc_fields_config = "avc_admin_fields";
        $this->templatesFolder = JPATH_ROOT . DS . 'modules' . DS . 'mod_avc' . DS . 'templates' . DS;
        $this->dbConfig = '#__avc_databases';
    ...
    protected function loadVisibleFields() {
        ...
        $query->from($this->dbObject->nameQuote('#__' . $this->avc_fields_config));
