...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure Lytebox ***/
		...
		this.inherit			= true;			// controls whether or not rel are inherited from the first link in a grouped set
	...
	/*** Configure Lytetip (tooltips) Options ***/
		...
		this.__tipStyle 		= 'classic';	// sets the default tip style if none is specified via rel. Possible values are classic, info, help, warning, error
...
Lytebox.prototype.updateLyteboxItems = function() {
	...
	for (var i = 0; i < lyteLinks.length; i++) {
		...
		if (myLink.getAttribute('href')) {
			...
			dataOptions = String(myLink.getAttribute('rel'));
...
Lytebox.prototype.launch = function(args) {
	...
	var oLauncher = this.doc.$('lbLauncher');
		...
		oLauncher.setAttribute('rel', sOptions);
...
Lytebox.prototype.start = function(oLink, bSlideshow, bFrame) {
	var dataOptions = String(oLink.getAttribute('rel'));
	...
	if (this.isEmpty(this.group)) {
		dataOptions = String(oLink.getAttribute('rel'));
		dataOptions = this.isEmpty(dataOptions) ? String(oLink.getAttribute('rev')) : dataOptions;
		if (this.isLyteframe) {			
